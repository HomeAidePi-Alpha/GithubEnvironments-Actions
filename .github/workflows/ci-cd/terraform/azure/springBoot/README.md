...
```
curl "https://nubesgen.com/gitops-alpha.zip?iactool=TERRAFORM&region=eastus&application=SPRING_CLOUD.standard&runtime=DOCKER&database=NONE.free&addons=application_insights,key_vault,cosmosdb_mongodb,storage_blob,redis&gitops=true" | tar -xzvf -
```
